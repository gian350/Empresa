...
<body>
    ...
    <section id="Seccion-Principal" class="body">
    	...
    	<h2 class="text-center" id="bloquetitulo">Modificar cliente</h2>
    	
    	
    	<div  id="bloquePrincipal">
    	
    		<div  id="bloqueIzq">
    			<form:form modelAttribute="updateCliente" method="get" action="../v1/clientes/${id}" Class="form" >
				   <div id="cajatabla">
				   
				   		<div class="form-group">
						    <label for="cliente" class="control-label">Codigo de cliente</label>
						    <form:input type="number" path="idCliente" Class="form-control" name="idCliente" />
    		...
    		<div  id="bloqueDer">
					  ...
					  <div id="cajatabla">
					   		<div class="form-group">
	    			<form:form modelAttribute="updateCliente" method="patch" action="../v1/clientes/${id}" Class="form" >
