...
<body>
    ...
    <section id="Seccion-Principal" class="body">
    	...
    	<h2 class="text-center" id="bloquetitulo">Eliminar cliente</h2>
    	
    	
    	<div  id="bloquePrincipal">
    	
    		<div  id="bloqueIzq">
    			<form:form modelAttribute="deleteCliente" method="get" action="../v1/clientes/${id}" Class="form" >
				   <div id="cajatabla">
    		...
    		<div  id="bloqueDer">
				...
				<div id="cajatabla">
					<figure id="bloqueImagen">
	                	<img id = "imagen" src="../img/eliminarCliente.jpg" alt="Contratar">
	              	</figure>
    			</div>
    		</div>
