		   ...
		   <tbody>
		    <c:forEach items="${pedidoList }" var="pedido" >
		     <tr>
		      ...
		      <td>${pedido.estado }</td>
		      <td>${pedido.cotizacion.idCotizacion }</td>
		      <td>${pedido.cotizacion.cantidad }</td>
		      <td>${pedido.cotizacion.fechaLimite }</td>
		      <td>${pedido.cotizacion.fechaEntrega }</td>
		      <td>${pedido.cotizacion.tipoEntrega }</td>
		      <td>${pedido.cotizacion.totalPagar }</td>
		      <td>${pedido.cotizacion.descuento }</td>
		      <td>${pedido.cotizacion.cliente.razonSocial }</td>
      		  <td>${pedido.cotizacion.producto.nombre }</td>
		     </tr>
		    </c:forEach>
		   </tbody>
		  </table>
