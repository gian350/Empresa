...
<body>
    ...
    <section id="Seccion-Principal" class="body">
    	...
    	<h2 class="text-center" id="bloquetitulo">Eliminar Pedido</h2>
    	
    	
    	<div  id="bloquePrincipal">
    	
    		<div  id="bloqueIzq">
    			<form:form modelAttribute="deletePedido" method="get" action="../v1/pedidos/${id}" Class="form" >
				   <div id="cajatabla">
    		...
    		<div  id="bloqueDer">
				...
				<div id="cajatabla">
					<figure id="bloqueImagen">
	                	<img id = "imagen" src="../img/eliminarPedido.jpg" alt="Contratar">
	              	</figure>
    			</div>
    		</div>
