...
<body>
    ...
    <section id="Seccion-Principal" class="body">
    	...
    	<h2 class="text-center" id="bloquetitulo">Registrar Pedido</h2>
    	<div  id="bloquePrincipal">
    	
    		<div  id="bloqueIzq">
    			<form:form modelAttribute="addPedido" method="post" action="../v1/savePedido" Class="form" >
				   <div id="cajatabla">
				   
				   		<div class="form-group">
						    <label for="estado" class="control-label">Estado</label>
						    <form:input type="estado" path="estado" Class="form-control" id="estado" />
					   	</div>
					   	
					   	<div class="form-group">
						    <label for="idCotizacion" class="control-label">Codigo de cotizacion</label>
						    <form:input type="number" path="cotizacion.idCotizacion" Class="form-control" id="idCotizacion" />
					   	</div>
    		...
    		<div  id="bloqueDer">
    			<figure id="bloqueImagen">
                	<img id = "imagen" src="../img/ingresarPedido.jpg" alt="Contratar">
              	</figure>
    		</div>
    	</div>
